...
db.getCollection("hbcc_receiver_cfg").insert({
    ...
    "mqcfg": {
        ...
        "addresses": [
            ...
            "mq1.finrunchain.com:5672"
        ]
    },
    "mongocfg": {
        "uri": "mongodb://mongouser:mongouser123@mongodb1.runchain.tech:27010,mongodb2.runchain.tech:27010,mongodb3.runchain.tech:27010/mongo",
        "database": "mongo",
...
db.getCollection("hbcc_receiver_cfg").insert({
    ...
    "mongocfg": {
        "uri": "mongodb://mongouser:mongouser123@mongodb1.runchain.tech:27010,mongodb2.runchain.tech:27010,mongodb3.runchain.tech:27010/mongoagent",
        "database": "mongoagent",
